...
let firstnameElem = mainForm.elements.namedItem("firstname"), middlenameElem = mainForm.elements.namedItem("middlename"), lastnameElem = mainForm.elements.namedItem("lastname"), imageElem = mainForm.elements.namedItem("image"), designationElem = mainForm.elements.namedItem("designation"), addressElem = mainForm.elements.namedItem("address"), emailElem = mainForm.elements.namedItem("email"), phonenoElem = mainForm.elements.namedItem("phoneno"), summaryElem = mainForm.elements.namedItem("summary");
// display elements
